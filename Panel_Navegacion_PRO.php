...
<body>
    <div class="navegacion">
        ...
        <nav class="sidebar">
            ...
            <div class="menu-section gestion-proveedores">
                <div class="menu-title">GESTIÓN DE PROVEEDORES</div>
                <a href="javascript:void(0);" onclick="cargarSeccion('proveedor')" class="menu-button">
                    <i class="fas fa-truck"></i> Proveedores
                </a>
                <a href="javascript:void(0);" onclick="cargarSeccion('p_agregar_eliminar')" class="menu-button">
                    <i class="fas fa-plus-minus"></i> Agregar / Eliminar
                </a>
                <a href="../Views/P_Modificar_Proveedor.php?Modify=true" class="menu-button">
                    <i class="fas fa-edit"></i> Modificar Proveedor
                </a>
                <a href="../Controllers/P_ControladorReporte.php?tipo=proveedores&accion=descargar" class="menu-button">
        ...
        <div class="contenido" id="contenido-dinamico">
            ...
            <div class="default-content">
                ...
                <p class="inventario-descripcion">
                    Aquí podrás gestionar toda la información relacionada con los proveedores que abastecen tu inventario. Aquí tendrás la posibilidad de <br>
                    registrar nuevos proveedores, ingresando detalles como su nombre, dirección, número de teléfono y correo electrónico. Además, podrás <br>
                    actualizar los datos de proveedores existentes, asegurándote de que la información esté siempre al día. Si un proveedor deja de ser <br>
                    relevante para tu negocio, también podrás eliminarlo del sistema. Este panel está diseñado para facilitar la consulta y la organización de <br>
                    tus socios comerciales, brindándote una manera sencilla y eficiente de acceder a toda la información clave sobre ellos.
                </p>
            </div>
        </div>
    </div>
