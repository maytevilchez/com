...
$userRole = $_SESSION['user']['role']; // Obtén el rol del usuario
?>
...
<head>
    ...
    <style>
        ...
        table th:nth-child(8), /* Suponiendo que la columna de Email es la quinta */
    ...
    <div class="navegacion">
        ...
        <nav class="sidebar">
            ...
            <div class="menu-section">
                ...
                <a href="javascript:void(0);" onclick="cargarSeccion('inventario')" class="menu-button">
                    <i class="fas fa-boxes"></i> Inventario
                </a>
                <a href="javascript:void(0);" onclick="cargarSeccion('agregar_eliminar')" class="menu-button">
                    <i class="fas fa-plus-minus"></i> Agregar / Eliminar
                </a>
                <a href="../Views/I_Modificar_Producto.php" class="menu-button">
                    <i class="fas fa-edit"></i> Modificar Producto
                </a>
                <a href="../Views/I_Generar_Reporte.php?generate=true" class="menu-button">
        ...
        <div class="contenido" id="contenido-dinamico">
            ...
            <div class="default-content">
                ...
                <p class="inventario-descripcion">
                    Aquí podrás gestionar tu inventario de manera eficiente, asegurando que cada producto esté siempre disponible y bajo control.<br>
                    Disfruta de una interfaz intuitiva que te permite agregar, modificar y eliminar productos con facilidad.<br>
                    Además, tendrás acceso a reportes detallados que te ayudarán a tomar decisiones informadas.<br>
                    ¡Comienza a optimizar tu gestión de inventarios hoy!
                </p>
            </div>
        </div>
    </div>
